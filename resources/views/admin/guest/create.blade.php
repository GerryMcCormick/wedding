...
@section('content')
    <h1 class="page-header">Add New Guest</h1>

    <div class="table-responsive">
        {!! Form::open(array('url' => 'admin/guest/store', 'files' => true)) !!}

        {{--@include('admin.partials.guestform', array('arr_att_statuses' => $arr_att_statuses))--}}
            ...
            <h5>Add Partner</h5>
            <p>{!! Form::checkbox('partner_check', '', false, [ 'id' => 'partner_check', 'label' => 'Partner']) !!}</p>
            ...
            <p>{!! Form::submit('Add Guest', ['id' => 'submit_button', 'class' => 'btn btn-primary']) !!}</p>
        {!! Form::close() !!}
    </div>
@endsection